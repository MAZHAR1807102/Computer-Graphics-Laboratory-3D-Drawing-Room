...
glm::vec3 cam = glm::vec3(0.0f, 1.20f, 3.0f);
...
int main()
{
   ...
   // glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setVec4("color", glm::vec4(.50f, 0.8431f, 0.7019f, 1.0f));
        ...
        model = translateMatrix * scaleMatrix;
        ourShader.setMat4("model", model);
        ourShader.setVec4("color", glm::vec4(0.80f, 0.90f, 0.90f, 1.0f)); 
        glBindVertexArray(VAO3);
      ...
      /* for (int i = 0; i < 3; i++)
       ...
       translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, -.2f, -2.8f));

       scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.9f, 1.5f, .02f));

       model = translateMatrix * scaleMatrix;
       ourShader.setMat4("model", model);
       ourShader.setVec4("color", glm::vec4(0.2f, 0.1f, 0.1f, 1.0f));
       ...
       translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, -.2f, -3.0f));

       scaleMatrix = glm::scale(identityMatrix, glm::vec3(3.9f, -0.5f, 1.5f));

       model = translateMatrix * scaleMatrix;
       ourShader.setMat4("model", model);
       ourShader.setVec4("color", glm::vec4(1.0f, 0.2f, 0.90f, 1.0f));
      ...
      translateMatrix = glm::translate(identityMatrix, glm::vec3(-3.6f, -1.0f, 1.31f));
...
/*  
        ...
        */
        ...
        if (fanOn)
        {
            ...
            ourShader.setMat4("model", model);
            ourShader.setVec4("color", glm::vec4(0.0, 0.8157f, 0.2f, 1.0f));
...
void draw(unsigned int VAO, glm::mat4 sm)
{
    ...
    //Table
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.5f, 0.0f, -0.5f));
    ...
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(6.0f, .2f, 3.0f));
    ...
    //leg1
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.5f, -1.0f, -0.5f));
    rotateXMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    rotateYMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    rotateZMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    //leg2
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.5f, -1.0f, 0.9f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2f, 2.0f, .2f));
    model = sm * translateMatrix * scaleMatrix;
    ourShader.setMat4("model", model);
    //ourShader.setVec3("aColor", glm::vec3(0.2f, 0.1f, 0.4f));
    ...
    //leg3
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-1.75f, -1.0f, 0.9f));
    rotateXMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    rotateYMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    rotateZMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2f, 2.0f, .2f));
    ...
    //leg4
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-1.75f, -1.0f, -0.5f));
    rotateXMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    rotateYMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    rotateZMatrix = glm::rotate(identityMatrix, glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2f, 2.0f, .2f));
    ...
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.5f, -1.3f, 2.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(5.0f, 1.0f, 2.2f));
    ...
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.5f, -.95f, 2.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(1.0f, 1.0f, 2.2f));

    model = sm * translateMatrix * scaleMatrix;
    ourShader.setMat4("model", model);
    ourShader.setVec4("color", glm::vec4(0.4f, 0.8f, 0.30f, 1.0f));

    glBindVertexArray(VAO);
    glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);

    translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, -.95f, 2.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(1.0f, 1.0f, 2.2f));

    model = sm * translateMatrix * scaleMatrix;
    ourShader.setMat4("model", model);
    ourShader.setVec4("color", glm::vec4(.4f, .8f, 0.30f, 1.0f));
...
/*   //Back of chair
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.45f, -.1f,-1.4f));
    ...
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.10f, -.4f, -1.0f));
    ...
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.1f, -.4f, -0.5f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2f, -1.0f, .2f));
    ...
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, -0.4f, -01.0f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2f, -1.0f, .2f));
    ...
    translateMatrix = glm::translate(identityMatrix, glm::vec3(-2.5f, -.4f, -0.6f));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2f, -1.0f, .2f));
